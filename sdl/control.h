...
#include "joysticks.h"
...
#elif XBOX
	#define	CONTROL_ESC                 (JOY_LIST_FIRST + 10)
	#define	CONTROL_DEFAULT1_UP         (JOY_LIST_FIRST + 21)
	#define	CONTROL_DEFAULT1_RIGHT		(JOY_LIST_FIRST + 22)
	#define	CONTROL_DEFAULT1_DOWN		(JOY_LIST_FIRST + 23)
	#define	CONTROL_DEFAULT1_LEFT		(JOY_LIST_FIRST + 24)
	#define CONTROL_DEFAULT1_FIRE1		(JOY_LIST_FIRST + 1)
	#define CONTROL_DEFAULT1_FIRE2		(JOY_LIST_FIRST + 2)
	#define	CONTROL_DEFAULT1_FIRE3		(JOY_LIST_FIRST + 7)
	#define	CONTROL_DEFAULT1_FIRE4		(JOY_LIST_FIRST + 8)
	#define	CONTROL_DEFAULT1_FIRE5		(JOY_LIST_FIRST + 3)
	#define	CONTROL_DEFAULT1_FIRE6		(JOY_LIST_FIRST + 4)
	#define CONTROL_DEFAULT1_START		(JOY_LIST_FIRST + 9)
	#define CONTROL_DEFAULT1_SCREENSHOT (JOY_LIST_FIRST + 12)

	#define	CONTROL_DEFAULT2_UP			((JOY_LIST_FIRST + 21) + JOY_MAX_INPUTS)
	#define	CONTROL_DEFAULT2_RIGHT		((JOY_LIST_FIRST + 22) + JOY_MAX_INPUTS)
	#define	CONTROL_DEFAULT2_DOWN		((JOY_LIST_FIRST + 23) + JOY_MAX_INPUTS)
	#define	CONTROL_DEFAULT2_LEFT		((JOY_LIST_FIRST + 24) + JOY_MAX_INPUTS)
	#define CONTROL_DEFAULT2_FIRE1		((JOY_LIST_FIRST + 1) + JOY_MAX_INPUTS)
	#define CONTROL_DEFAULT2_FIRE2		((JOY_LIST_FIRST + 2) + JOY_MAX_INPUTS)
	...
	#define	CONTROL_DEFAULT2_FIRE5		((JOY_LIST_FIRST + 3) + JOY_MAX_INPUTS)
	#define	CONTROL_DEFAULT2_FIRE6		((JOY_LIST_FIRST + 4) + JOY_MAX_INPUTS)
	#define CONTROL_DEFAULT2_START		((JOY_LIST_FIRST + 9) + JOY_MAX_INPUTS)
	#define CONTROL_DEFAULT2_SCREENSHOT ((JOY_LIST_FIRST + 12) + JOY_MAX_INPUTS)

	#define	CONTROL_DEFAULT3_UP			((JOY_LIST_FIRST + 21) + (JOY_MAX_INPUTS * 2))
	#define	CONTROL_DEFAULT3_RIGHT		((JOY_LIST_FIRST + 22) + (JOY_MAX_INPUTS * 2))
	#define	CONTROL_DEFAULT3_DOWN		((JOY_LIST_FIRST + 23) + (JOY_MAX_INPUTS * 2))
	#define	CONTROL_DEFAULT3_LEFT		((JOY_LIST_FIRST + 24) + (JOY_MAX_INPUTS * 2))
	#define CONTROL_DEFAULT3_FIRE1		((JOY_LIST_FIRST + 1) + (JOY_MAX_INPUTS * 2))
	#define CONTROL_DEFAULT3_FIRE2		((JOY_LIST_FIRST + 2) + (JOY_MAX_INPUTS * 2))
	...
	#define	CONTROL_DEFAULT3_FIRE5		((JOY_LIST_FIRST + 3) + (JOY_MAX_INPUTS * 2))
	#define	CONTROL_DEFAULT3_FIRE6		((JOY_LIST_FIRST + 4) + (JOY_MAX_INPUTS * 2))
	#define CONTROL_DEFAULT3_START		((JOY_LIST_FIRST + 9) + (JOY_MAX_INPUTS * 2))
	#define CONTROL_DEFAULT3_SCREENSHOT ((JOY_LIST_FIRST + 12) + (JOY_MAX_INPUTS * 2))

	#define	CONTROL_DEFAULT4_UP			((JOY_LIST_FIRST + 21) + (JOY_MAX_INPUTS * 3))
	#define	CONTROL_DEFAULT4_RIGHT		((JOY_LIST_FIRST + 24) + (JOY_MAX_INPUTS * 3))
	#define	CONTROL_DEFAULT4_DOWN		((JOY_LIST_FIRST + 23) + (JOY_MAX_INPUTS * 3))
	#define	CONTROL_DEFAULT4_LEFT		((JOY_LIST_FIRST + 24) + (JOY_MAX_INPUTS * 3))
	#define CONTROL_DEFAULT4_FIRE1		((JOY_LIST_FIRST + 1) + (JOY_MAX_INPUTS * 3))
	#define CONTROL_DEFAULT4_FIRE2		((JOY_LIST_FIRST + 2) + (JOY_MAX_INPUTS * 3))
	...
	#define	CONTROL_DEFAULT4_FIRE5		((JOY_LIST_FIRST + 3) + (JOY_MAX_INPUTS * 3))
	#define	CONTROL_DEFAULT4_FIRE6		((JOY_LIST_FIRST + 4) + (JOY_MAX_INPUTS * 3))
	#define CONTROL_DEFAULT4_START		((JOY_LIST_FIRST + 9) + (JOY_MAX_INPUTS * 3))
