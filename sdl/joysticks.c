...
const char *Microsoft360KeyName[JOY_NAME_SIZE] = {
	"...",
#define MICROSOFT360_NAMES(x) \
	x" A",              \
	x" B",              \
	x" X",              \
	x" Y",              \
	...
	x" unknown 31",     \
	x" unknown 32",
	MICROSOFT360_NAMES("P1")
	MICROSOFT360_NAMES("P2")
	MICROSOFT360_NAMES("P3")
	MICROSOFT360_NAMES("P4")
	"undefined"
};
